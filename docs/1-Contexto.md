...
## Objetivos Gerais:
Implementar um sistema de gestão digital que elimine os controles manuais, permitindo o agendamento de horários em tempo real, o monitoramento rigoroso do estoque de produtos e o controle total do fluxo financeiro em uma única plataforma.
...
## Justificativa
Automatizar processos em pequenos negócios permite melhorar a organização, reduzir erros manuais e facilitar o controle das atividades.
No caso das barbearias, um sistema de gestão pode ajudar no controle de gestão de clientes, gestão de agendamentos, gestão de finanças, gestão de estoque e avaliação dos serviços.
...
Clientes, usuários que realizam agendamentos e avaliam os serviços prestados.
